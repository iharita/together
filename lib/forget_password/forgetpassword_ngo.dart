...
import 'package:together/forget_password/otp_ngo.dart';

class ForgetNGO extends StatelessWidget {
  const ForgetNGO({Key? key}) : super(key: key);
        ...
        body: Column(
          ...
          children: [
            ...
            MaterialButton(
              ...
              height: 60.0,
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=> const OTPNGO()));
              },
              color: primaryColor,
