...
import 'package:together/forget_password/resetpassword_ngo.dart';

class OTPNGO extends StatelessWidget {
  const OTPNGO({Key? key}) : super(key: key);
        ...
        body: Column(
          ...
          children: [
            ...
            MaterialButton(
              ...
              height: 60.0,
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=> const ResetNGO()));
              },
              color: primaryColor,
